...
public class IssueWPT implements java.io.Serializable{
	...
	public IssueWPT(String teamPk, String projectPk, String memberPk, String role, String projectName) {
		super();
		this.teamPk = teamPk;
	...
	public String toString() {
		return "IssueWPT [teamPk=" + teamPk + ", projectPk=" + projectPk + ", memberPk=" + memberPk + ", role="
