		...
		<div class="panel-heading">
			...
			<table id="issueTable">	
				<tr>
					...
					<td class="thRange"><button class="okBtn" type="button" onclick="sweetTest();"><i class="fas fa-check"></i>&nbsp;승인</button></td>
			...
			.then((willDelete) => {
			  if (willDelete) {
			    swal({
			    	...
			    	location.href="RequestApprovalList.iu";
			    });
			  } else {
				  swal({
				  	title: "취소 하셨습니다.",
